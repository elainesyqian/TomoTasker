...
public class StreakCounter {
	...
	// must do this bc cannot just write 1 date into the file, buffered writer will
	...
	// this method draws the current streak to screen and recalculates the streak if
	// necessary
